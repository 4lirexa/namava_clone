...
const config ={
    baseURL : 'https://namava-proxy-api.onrender.com', // http://localhost:3004
    SliderTypes : {
        Banner : "Banner",
        Series : "Series",
        Movie : "Movie",
    ...
    sections : {
        [pageItemsType.Slider] : {
            url : 'api/v2.0/medias/sliders/{{sliderID}}'
        },
        ...
        "SinglePageRelated" : {
            url : "api/v1.0/medias/{{PAYLOAD_KEY}}/recommend-items-anonymous-user",
