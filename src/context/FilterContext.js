...
import { useMenusContext } from './MenuContext';
...
const reducer = (state,action)=>{
    ...
    switch(action.type){
        ...
        case types.CLEAR_ALL:
            ...
            break;
        default : 
            throw Error(`an unkownAction to Filter Reducer ${action.type}` )
    }
...
const useFilter = (fetchGenre = false)=> {
    ...
    if(!context){
        throw Error('useSliderContext must be used inside FilterProvider')
    }
...
export {FilterProvider,useFilter,types};