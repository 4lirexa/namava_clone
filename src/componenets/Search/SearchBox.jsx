...
import { fetchData, searchCountriesFilter, searchDubsSubtitleFilter, searchGenreFilter, searchSortFilter, searchYearFilter } from '../../Utils/functions';
...
const fetchSearchItems = (queryString,filter,term,onSearchItems) => {
    ...
    params = {...params, ...searchGenreFilter(urlSearchParams,filter)}
    params = {...params, ...searchYearFilter(urlSearchParams,filter)}
    params = {...params, ...searchSortFilter(urlSearchParams,filter)}
    params = {...params, ...searchDubsSubtitleFilter(urlSearchParams,filter)}
...
function SearchBox({onSearchItems}) {
