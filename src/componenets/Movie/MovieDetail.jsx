...
function getDefaultButton(data){
    ...
    return data['type'] !== config.SliderTypes.Series ? 
...
function MovieDetail({data,loading,topMedia}) {
    let imageUrl;
                ...
                }
                {
                    ...
                    <React.Fragment>
                        ...
                        <div className="detail-row">
                            ...
                            { data['year'] && (<div className="detail-item">
                                {data['year']}
                            </div>)}

                            { data['mediaDuration'] && (<div className="detail-item">
                            ...
                            {data['hit'] && data['hit'] !== null && data['hit'] !== 0 && (
                                <div className="detail-item has-icon">
